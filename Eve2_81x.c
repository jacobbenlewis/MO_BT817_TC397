...
uint8_t Cmd_READ_REG_ID(void)
{
    ...
    //Ported TC397 code
    g_qspi.spiBuffers.spiMasterTxBuffer[0]=0x30;
    g_qspi.spiBuffers.spiMasterTxBuffer[1]=0x20;
    g_qspi.spiBuffers.spiMasterTxBuffer[2]=REG_ID;
    g_qspi.spiBuffers.spiMasterTxBuffer[3]=0x00;
    g_qspi.spiBuffers.spiMasterTxBuffer[4]=0x00;
    ...
    if (g_qspi.spiBuffers.spiMasterRxBuffer[4] == 0x7C) // FT81x Datasheet section 5.1, Table 5-2. Return value always 0x7C
    {
      return 1;
    }
    else
...
//Not ported, requires manual CS pin control
//  HAL_SPI_Enable();
//  if (reading)
//  {
